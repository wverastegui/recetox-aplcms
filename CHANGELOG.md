...
- refactored `cont.index.R` and renamed as `run_filter.R` [#155](https://github.com/RECETOX/recetox-aplcms/pull/155)
- Updated function names `proc.cdf.R` and `extract_features.R` [#155](https://github.com/RECETOX/recetox-aplcms/pull/155)
- refactored `cont.index.R` and renamed as `run_filter.R` [#155](https://github.com/RECETOX/recetox-aplcms/pull/155)
